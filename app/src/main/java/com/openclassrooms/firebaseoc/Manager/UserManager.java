...
public class UserManager {
    ...
    public Task<User> getUserData(){
        // Get the user from Firestore and cast it to a User model Object, we use continuewith pour permettre de récupérer le résultat d'un task et effectuer un traitement sur lui
